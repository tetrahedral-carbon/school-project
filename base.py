...
# my_object = AI({"initial": "this dictionary contains a set of questions and answers on a scale of 1 to 5 (1-strongly disagree, 5-strongly agree). recommend 3 suitable career options and put the entire thing (career+explanation for it) for all 3 in python strings. do not initialize variables. at the end give me a string of the 3 options in python syntax only, not a list of strings. do not use bold letters.", 
#                 "i am very honest": 5, 
#                 "i like cars": 2, 
#                 "i am very social": 3,
#                 "i enjoy travelling": 4})
# my_object.give_ai_data()
# answer = str(my_object.pass_result()).split("'")
# print(answer[1], answer[3], answer[5], answer[7])
